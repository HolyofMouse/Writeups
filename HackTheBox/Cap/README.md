...
Wireshark data 
![alt](find_username_cap.png)
![alt](find_password_cap.png)
ответ: ftp
...
User flag 
![alt](get_user_flag.png)
![alt](userflag_view_cap.png)
...
python http.server start on port 80 
![alt](python_server_cap.png)
![alt](get_linpeas_cap.png)
![alt](start_linpease_cap.png)
![alt](find_vulnerability.png)
