...
Сканирование машины ![](files_photo/nmap_scan_cap.png)
ответ: 3
...
WebUI сканер ![](files_photo/webui_cap.png)
ответ: data
...
movement between users ![](files_photo/admin_webui_cap.png)
ответ: да

4 Какой идентификатор файла PCAP, содержащего конфиденциальные данные?
Admin panel ![](files_photo/admin_webui_cap.png)
ответ: 0
...
Wireshark data ![](files_photo/find_username_cap.png)
![](files_photo/find_password_cap.png)
ответ: ftp
...
зная что у нас есть ещё и 22 порт отвечающий за ssh пробуем подключиться к нему с имеющимися у нас логином и паролем
 ...
 ssh_session ![](files_photo/get_ssh_session_cap.png)
 ответ: ssh
...
User flag ![](files_photo/get_user_flag.png)
![](files_photo/userflag_view_cap.png)
флаг получен
...
python http.server start on port 80 ![](files_photo/python_server_cap.png)
![](files_photo/get_linpeas_cap.png)
![](files_photo/start_linpease_cap.png)
![](files_photo/find_vulnerability.png)
...
Privilege Escalation ![](files_photo/get_root.png)
![](files_photo/get_root_flag.png)
